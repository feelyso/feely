...
import { ChevronDown } from "@feely/ui/components/icon";
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Root ref={ref} className={cn("navigation-menu-component", className)} {...props}>
    {children}
...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn("navigation-menu-list  group", className)}
    {...props}
  />
));
...
const navigationMenuTriggerStyle = cva("navigation-menu-trigger-style group");
