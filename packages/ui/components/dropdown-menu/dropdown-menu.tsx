...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn("dropdown-menu-subtrigger data-[state=open]:bg-item-hover", inset && "pl-8", className)}
    {...props}>
    {children}
    <ChevronRight className="dropdown-menu-subtrigger-icon" />
  </DropdownMenuPrimitive.SubTrigger>
));
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn("dropdown-menu-item", inset && "pl-8", className)}
    {...props}
  />
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    checked={checked}
    {...props}>
    <span className="dropdown-menu-checkbox-container">
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem ref={ref} className={cn("dropdown-menu-radio-item", className)} {...props}>
    <span className="dropdown-menu-radio-container">
      <DropdownMenuPrimitive.ItemIndicator>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("dropdown-menu-label", inset && "pl-8", className)}
    {...props}
  />
));
