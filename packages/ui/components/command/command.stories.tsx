  ...
  return (
    <>
      <p className="text-sm text-description">
        Press{' '}
        <kbd className="pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border border-default bg-muted px-1 font-mono text-[10px] font-medium text-description opacity-visible">
