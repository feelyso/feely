...
import {
  SelectPreview, SelectScrollable, SelectWithForm
} from '@components/preview/select.tsx';
...
<Tabs items={['Preview', 'Code']}>
  ...
  import { Select, SelectContent, SelectGroup, SelectItem, SelectLabel, SelectTrigger, SelectValue } from "@feely/ui/components/select"
...
```js copy {6} /Label/
import { Select } from "@feely/ui/components/select"
