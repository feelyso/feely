...
import { AccessibilityTable } from '@components/accessibility/accessibilityTable.mdx';
import { segmentedAccessibilityData } from '@components/accessibility/segmented.mdx';
import { SegmentedPreview, SegmentedDefaultValue, SegmentedDisabled, SegmentedWithIcon } from '@components/preview/segmented.tsx'
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    import { Segmented, SegmentedContent, SegmentedList, SegmentedTrigger } from "@/components/segmented"
...
<Cards className='mt-8'>
  ...
  <Card
    title="🪄 Figma"
    href="https://www.figma.com/file/acdO58jx9zgGfkKu6htrx2/%F0%9F%94%B5-Fusillo-Design-System?type=design&node-id=763%3A3968&mode=design&t=BNqih1pZMuav038B-1"
  />
  <Card
    title="🐝 API Reference"
