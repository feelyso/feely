...
import { tabsAccessibilityData } from '@components/accessibility/tabs.mdx';
import { TabsPreview, TabsDefault, TabsDefaultValue, TabsDisabled, TabsWithIcon, TabsWithCard } from '@components/preview/tabs.tsx'
