...
import { IReplyComment, IVoteComment } from "app/api/apiServerActions/commentApiServerAction";
...
export const useVoteComment = () => {
  ...
  return useMutation<{ data: { message: string } }, null, IVoteCommentForInvalidation>(voteIdeaFunction, {
...
export const useReplyComment = () => {
  ...
  return useMutation<{ data: { message: string } }, null, IReplyComment>(voteIdeaFunction, {
    onSettled: (_a, _b, variables) => {
      queryClient.invalidateQueries([Endpoints.idea.getIdeasByWorkspaceName]);
      queryClient.invalidateQueries([Endpoints.idea.main, variables.ideaId]);
    },
